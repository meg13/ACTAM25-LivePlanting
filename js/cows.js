    ...
    create() {
        ...
        this.element.innerHTML = `
            <svg width="80" height="64" viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 22C0 18.6863 2.68629 16 6 16H58C61.3137 16 64 18.6863 64 22V58C64 61.3137 61.3137 64 58 64H6C2.68629 64 0 61.3137 0 58V22Z" fill="#A0826D"/>
                <path d="M32 6C32 2.68629 34.6863 0 38 0H66C69.3137 0 72 2.68629 72 6V34C72 37.3137 69.3137 40 66 40H38C34.6863 40 32 37.3137 32 34V6Z" fill="#A0826D"/>
                <rect width="16" height="16" transform="translate(64 16)" fill="#8B6F5E"/>
                ...
                <rect width="12" height="12" transform="translate(36)" fill="#8B6F5E"/>
                <rect width="12" height="12" transform="translate(8 52)" fill="#8B6F5E"/>
                <rect width="12" height="12" transform="translate(28 52)" fill="#8B6F5E"/>
            </svg>
        `;
